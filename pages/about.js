                ...
                <div className="grid gap-4 lg:grid-cols-3 sm:grid-cols-2 p-4">
                    <div className="max-w-sm bg-slate-400 rounded overflow-hidden shadow-lg mx-auto hover:scale-110 transition duration-300 ease-in-out">
                        ...
                        <div className="px-6 py-4">
                            ...
                            <p className="text-base">
                                A place for students to find remote music
                            ...
                            <div className="flex justify-between mt-10 items-end">
                                <a
                                    className="underline"
                                    href="https://musicly-swart.vercel.app/"
                                >
                                ...
                                <a href="https://github.com/WaltersMatthew/musicly">
                                    <img
                    ...
                    <div className="max-w-sm bg-slate-400 rounded overflow-hidden shadow-lg mx-auto hover:scale-110 transition duration-300 ease-in-out">
                        ...
                        <div className="px-6 py-4">
                            ...
                            <p className="text-base">
                                A social app for all things cats! A mobile-first
                            ...
                            <div className="flex justify-between mt-10 items-end">
                                <a
                                    className="underline"
                                    href="https://lucky-pudding-9e4bf7.netlify.app/"
                                >
                                    <button className="bg-slate-700 hover:bg-black text-white transition ease-in-out mx-2 p-2 rounded-xl hover:scale-125 transition duration-300 ease-in-out">
                                        Live Deployment
                                    </button>
                    ...
                    <div className="max-w-sm bg-slate-400 rounded overflow-hidden shadow-lg mx-auto hover:scale-110 transition duration-300 ease-in-out">
                        ...
                        <div className="px-6 py-4">
                            ...
                            <p className="text-base">
                                An all-in-one spot for book lovers to find their
                            ...
                            <div className="flex justify-between mt-10 items-end">
                                <a
                                    className="underline"
                                    href="https://booktalk-waltersmatthew.koyeb.app/"
                                >
                                    <button className="bg-slate-700 hover:bg-black text-white transition ease-in-out mx-2 p-2 rounded-xl hover:scale-125 transition duration-300 ease-in-out">
                                        Live Deployment
                                    </button>
                                </a>
                                <a href="https://github.com/WaltersMatthew/BookTalk">
                                    <img
                                        className="max-h-14 hover:scale-125 transition duration-300 ease-in-out"
                                        src="github.png"
                                        alt="github logo"
                    ...
                    <div className="max-w-sm bg-slate-400 rounded overflow-hidden shadow-lg mx-auto hover:scale-110 transition duration-300 ease-in-out">
                        ...
                        <div className="px-6 py-4">
                            ...
                            <p className="text-base">
                                A fun take on a classic side-scrolling platform
                            ...
                            <div className="flex justify-between mt-10 items-end">
                                <a
                                    className="underline"
                                    href="https://waltersmatthew.github.io/Fritz-in-the-City/"
                                >
                                    <button className="bg-slate-700 hover:bg-black text-white transition ease-in-out mx-2 p-2 rounded-xl  hover:scale-125 transition duration-300 ease-in-out">
                                        Live Deployment
                                    </button>
                                ...
                                <a href="https://github.com/WaltersMatthew/Fritz-in-the-City">
                                    <img
                                        className="max-h-14  hover:scale-125 transition duration-300 ease-in-out"
                                        src="github.png"
                                        alt="github logo"
